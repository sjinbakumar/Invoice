...
define('ENABLE_VAT', true); // Enable TAX/CGST
define('ENABLE_VATS', true); // Enable TAX/SGST
define('VAT_INCLUDED', false); // Is CGST included or excluded?
define('VAT_INCLUDEDS', false); // Is SGSTT included or excluded?
define('VAT_RATE', '10'); // This is the percentage value
define('VAT_RATES', '10'); // This is the percentage value
