		...
		<form method="post" id="create_invoice">
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					...
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
							<strong>TAX/CGST:</strong><br>Remove TAX/CGST <input type="checkbox" class="remove_vat">
						</div>
						<div class="col-xs-3">
					...
					<?php if (ENABLE_VATS == true) { ?>
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
							<strong>TAX/SGST:</strong><br>Remove TAX/SGST <input type="checkbox" class="remove_vats">
						</div>
						<div class="col-xs-3">
							<?php echo CURRENCY ?><span class="invoice-vats" data-enable-vats="<?php echo ENABLE_VATS ?>" data-vat-rates="<?php echo VAT_RATES ?>" data-vat-methods="<?php echo VAT_INCLUDEDS ?>">0.00</span>
							<input type="hidden" name="invoice_vats" id="invoice_vats">
						</div>
					</div>
					<?php } ?>
